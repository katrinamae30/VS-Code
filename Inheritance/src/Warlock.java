public class Warlock extends Character {
    ...
    public void multiattacker(Character mainCharacter) {
        System.out.println(
                super.characterName + " attacks " + mainCharacter.characterName + " with Multiattacker ( Damage - 10)");
        int dp = 10;
        int manacost = 15;
    ...
    public void multiattacker(Wizard jadis) {
    }
}